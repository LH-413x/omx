...
struct Harness : public RefBase {
    ...
    status_t testSeek(
            const std::string componentName, const std::string componentRole);
...
private:
    ...
    std::string mUri;
    std::unordered_map<std::string, std::string> componentNameMapRole;
    std::unordered_map<std::string, std::string> mRoleMapMime;
    status_t initOMX();
